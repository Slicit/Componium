...
usage:
  ...
  componium node [flags]        run a software instrument node, no hardware needed
  componium studio [flags]      edit a score in a browser
  componium import-vision       move .seen.jsonl files into a database
